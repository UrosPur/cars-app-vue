    ...
    <div>
        <form  @submit.prevent="addCar" >
            <div class="form-row">
                ...
                <div class="col">
                    <input v-model="newCar.engine" class="form-check-input" type="radio" name="exampleRadios" value="diesel">
                    <label class="form-check-label" >
                        diesel
                    </label>
                    <div class="col">
                    <input v-model="newCar.engine" class="form-check-input" type="radio" name="exampleRadios" value="electric">
                    <label class="form-check-label" >
                        electric
                    </label>
                    </div>
                    <div class="col">
                    <input v-model="newCar.engine" class="form-check-input" type="radio" name="exampleRadios"  value="petrol">
                    <label class="form-check-label">
                        petrol
                    </label>
                </div>
